...
어렵고 복잡한 금융 용어를 배제하고, 간단하고 이해하기 쉬운 정보를 제공합니다.  
특히, 사용자의 나이와 요구에 맞춘 맞춤형 상품 추천을 통해 금융 상품 탐색을 돕습니다.
...
| 이름   | 역할                          | 주요 담당 업무                         |
|--------|-------------------------------|---------------------------------------|
| 팀원1  | 백엔드 개발 및 데이터베이스 설계 | 금융 상품 API 연동, 데이터 모델링 및 DB 관리 |
| 팀원2  | 프론트엔드 개발 및 서비스 디자인 | Vue 기반 UI/UX 개발, 사용자 인터페이스 설계 |
...
- **기타**: 생성형 AI (추천 알고리즘 최적화 및 데이터 분류)
...
- **구현 수준**
  - 주요 기능 완성: 예적금 추천 알고리즘, 연령 기반 상품 필터링
  - 추가 기능 구현 중: 사용자 프로필 커스터마이징, 상품 비교 페이지
...
- **팀원 후기**
  - 팀원1: "데이터베이스 설계와 API 연동을 통해 금융 데이터의 활용 가능성을 경험했습니다."
  - 팀원2: "초보 사용자도 이해하기 쉬운 UI/UX를 설계하는 데 중점을 두었습니다."
```
